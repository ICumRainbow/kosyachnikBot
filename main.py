...
# TOKEN = os.environ['TOKEN_TEST']  # This API TOKEN IS FOR TESTING - @Testing_bot4testing_bot
TOKEN = os.environ['TOKEN_PROD']  # This API TOKEN IS FOR PRODUCTION - @kosyachnik_bot
